...
const usb_descriptor_list_t usb_descriptor_list[] = {
    ...
    {0x2100, KEYBOARD_INTERFACE, hid_descriptor_keyboard, sizeof(hid_descriptor_keyboard)},
    {0x2200, KEYBOARD_INTERFACE, report_descriptor_keyboard, sizeof(report_descriptor_keyboard)},
    // #endif
